...
public class Vista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("<html><body style=\"text-align: center;\">APLICACIÓN DE GENERACIÓN DE REPORTES<br>DE MATRÍCULAS PARA<br>LA UNIVERSIDAD NACIONAL DE INGENIERÍA (UNI)</body></html>");
    ...
    public void ComprobarClick() {
        String[] args = new String[0];
        if (jButton1.getModel().isPressed()) {
            Matricula.main(args);
        } else if (jButton1.getModel().isPressed()) {
            Matricula.main(args);
        }
    }
